...
def main():
    ...
    for index in subset["indices"]:
        selected_file, label = dst_train.imgs[index]
        target_file = selected_file.replace(args.dataset, f"{args.dataset}_{args.selection}_{args.selection_epochs}_{args.lr}")
